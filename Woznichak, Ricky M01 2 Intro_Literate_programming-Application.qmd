...
<style>
.wooden-frame {
  border: 5px solid transparent;  /* Thick border */
  padding: 5px;  /* Space inside frame */
  background-image: url('https://static.vecteezy.com/system/resources/thumbnails/006/550/927/small/realistic-texture-pattern-of-dark-wood-background-vector.jpg'); /* Wood texture */
...
![*I believe I have satisfied the above requirements. Thank you :)*](Exercise10.png){width="1500" class="wooden-frame"}
